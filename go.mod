...
require (
	...
	github.com/salamsites/package-http v0.0.0-20250805092020-6cbc1e482c7c
...
require (
	...
	github.com/Hajymuhammet/elasticsearch-package v0.0.0-20250911093703-3f4fd5d3e66f // indirect
