...
//func (p *CarsPsqlRepository) GetMyFeeds(ctx context.Context, limit, page int64, search, status string) ([]models.GetAllFeeds, error) {
//	var result []models.GetAllFeeds
//	query := `SELECT
//    c.id,
//    'car' AS type,
//    s.id   AS stock_id,
...
//    c.name, c.price, c.year, c.status, c.images,
//    c.created_at
//FROM cars c
...
//
//	for rows.Next() {
//		var feed models.V1GetAllMyFeeds
//		err = rows.Scan(
//			&feed.Id,
//			&feed.Type, // added type
//			&feed.Stock.Id,
//			&feed.Stock.Name,
//			&feed.Brand.Id,
//			&feed.Brand.Name,
...
//			&feed.Status,
//			&feed.Images,
//			&feed.CreatedAt, // added created_at
//		)
//		if err != nil {
//			p.logger.Error(err)
//			return nil, err
