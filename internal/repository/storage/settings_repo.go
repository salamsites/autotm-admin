...
type SettingsRepository interface {
	...
	GetAllRoles(ctx context.Context, limit, page int64, search string) ([]models.Role, error)
	GetRolesCount(ctx context.Context, search string) (int64, error)
	...
	GetAllUsers(ctx context.Context, limit, page int64, search string) ([]models.User, error)
